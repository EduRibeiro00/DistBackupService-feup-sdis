...
public class Peer implements RemoteInterface {
    ...
    private ServerInitiator serverInitiator;

    /**
     * Constructor of the class
     * @param serverInitiator peer that is going to fulfill the requests that the link will send
     */
    public Peer(ServerInitiator serverInitiator) {
        this.serverInitiator = serverInitiator;
    }
